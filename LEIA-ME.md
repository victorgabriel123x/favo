...
- Abertura em cascata na primeira tela: logo, título subindo linha a linha, texto, botões e pratos, com a elipse se desenhando sozinha
- Parallax discreto: os pratos e as fotos das seções deslizam em ritmos diferentes conforme a rolagem
- Menu do celular abrindo em cascata e botão do WhatsApp com pulso lento
- Rolagem suave, animações de entrada nas seções e respeito à configuração de movimento reduzido do sistema (quem liga essa opção vê a página inteira parada, sem nada escondido)
